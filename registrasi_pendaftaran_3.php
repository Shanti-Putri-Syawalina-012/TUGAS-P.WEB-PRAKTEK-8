...
<body>
	...
	<div class="container" style="background-color: white; width: 800px; min-height: 400px; border-radius: 5px; box-shadow: 0 0 5px rgba(0, 0, 0, 0.3); padding: 50px 10px;">
		<form method="post" action="proses_kependaftaran4.php">
			<table cellspacing="4" style="margin-top: 20px;">
				<tr>
					...
					<br>
					<h3 style="font-size: 20px; font-weight: 400; text-align: center;">DATA AYAH KANDUNG</h3>
				</tr>
			<tr>
			...
			<tr>
				<td>Tahun Lahir</td>
				<td>
					<input type="date" name="tahun_lahir" value="<?php echo $d['tahun_lahir']; ?>">
				</td>
			</tr>
			<tr>
				<td>Pendidikan</td>
			...
			<tr>
				...
				<td>
					<a href="registrasi_pendaftaran_4.php"></a>
